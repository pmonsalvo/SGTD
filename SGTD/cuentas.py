...
class Cuentas(object):
    ...
    def __init__(self):
        ...
        self.winMain.set_title('Pagos Crédito')
    ...
    def cargarCombo(self):
        ...
        lista.append([4,'Cantidad de Pagos'])
        lista.append([5,'Monto a Pagar (Fraccionado)'])
        lista.append([6,'Monto Total'])
